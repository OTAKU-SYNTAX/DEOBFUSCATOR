...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(chatId, `👋 Hello! Welcome to Oreki Bot.\n\n🎵 Send a *voice message* or use /shazam to recognize a song.`, {
        parse_mode: 'Markdown'
    });
});

// /shazam command (Alternative to sending a voice note)
bot.onText(/\/shazam/, (msg) => {
    bot.sendMessage(msg.chat.id, "🎵 Send me a *voice message*, and I'll recognize the song!", {
        parse_mode: "Markdown"
    });
});

// Voice message handling for song recognition
